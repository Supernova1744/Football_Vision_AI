...
from external.soccer_data import SoccerPitchConfiguration
...
def draw_pitch_voronoi_diagram(
    ...
    team_1_color_bgr = np.array(team_1_color[::-1], dtype=np.uint8)
    team_2_color_bgr = np.array(team_2_color[::-1], dtype=np.uint8)
